...
class AbortDetailActivity : AppCompatActivity() {
    ...
    private val iHandlerIntent: HandlerUtils.IHandlerIntent = object : HandlerUtils.IHandlerIntent {
        override fun handlerIntent(msg: Message) {
            when (msg.what) {
                ...
                MSG_IS_BUSY -> {
                    Toast.makeText(this@AbortDetailActivity, R.string.printer_is_working, Toast.LENGTH_SHORT).show()
                }
                MSG_PAPER_LESS -> {
                    loopPrintFlag = DEFAULT_LOOP_PRINT
                    Toast.makeText(this@AbortDetailActivity, R.string.out_of_paper, Toast.LENGTH_SHORT).show()
                }
                MSG_PAPER_EXISTS -> {
                    Toast.makeText(this@AbortDetailActivity, R.string.exists_paper, Toast.LENGTH_SHORT).show()
                }
                MSG_THP_HIGH_TEMP -> {
                    Toast.makeText(this@AbortDetailActivity, R.string.printer_high_temp_alarm, Toast.LENGTH_SHORT).show()
                }
                MSG_MOTOR_HIGH_TEMP -> {
                    loopPrintFlag = DEFAULT_LOOP_PRINT
                    Toast.makeText(this@AbortDetailActivity, R.string.motor_high_temp_alarm, Toast.LENGTH_SHORT).show()
                ...
                MSG_CURRENT_TASK_PRINT_COMPLETE -> {
                    Toast.makeText(this@AbortDetailActivity, R.string.printer_current_task_print_complete, Toast.LENGTH_SHORT).show()
                }
                else -> {
                    // Default case
                }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tvCardId = findViewById<TextView>(R.id.tv_card_id)
        tvCardId.text = getString(R.string.card_id_placeholder, transactionCardId)
        ...
        val dateText = getString(R.string.date_placeholder, currentDate)
        dateTextView.text = dateText

        val timeTextView = findViewById<TextView>(R.id.tv_time)
        val timeText = getString(R.string.time_placeholder, currentTime)
